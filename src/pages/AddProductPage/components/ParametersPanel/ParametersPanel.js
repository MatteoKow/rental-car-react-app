                ...
                <div className='parameter-info'>
                    <div className='part1'>
                        ...
                        <div className='input-row'>
                            ...
                            <select onChange={handleAC}>
                                <option value={0}>Czy jest A/C</option>
                                {ACList}
                            </select>
                        </div>
                        <div className='input-row'>
                            <SpecificationIcon icon={TransmissionIcon} alt=""/>
                            <select onChange={handleTransmision}>
                                <option value={0}>Wybierz skrzynie biegów</option>
                                {transmissionsList}
                            </select>
                        </div>
